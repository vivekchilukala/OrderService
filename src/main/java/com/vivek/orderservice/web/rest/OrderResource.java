...
import com.vivek.orderservice.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.vivek.orderservice.domain.Order}.
 */
@RestController
@RequestMapping("/api")
public class OrderResource {
    ...
    public OrderResource(OrderService orderService, OrderListService orderListService) {
     ...
     */
    @PostMapping("/orders")
    public ResponseEntity<OrderDTO> createOrder(@RequestBody OrderCreateRequest orderDTO) throws URISyntaxException {
     ...
     */
    @PutMapping("/orders")
    public ResponseEntity<OrderDTO> updateOrder(@RequestBody OrderCreateRequest orderDTO) throws URISyntaxException {
